    ...
    return (
        <div className='p-4'>
            <p className='text-[19px] text-justify'>
                ...
                With a vast collection of books, research papers, articles, and academic materials, RPITST E-Library serves as a valuable resource for students looking to enhance their knowledge and excel in their studies. We strive to bridge the gap between students and quality learning materials by offering a user-friendly interface, powerful search functionalities, and seamless access to digital content.

                RPITST E-LIBRARY platform supports multiple categories, including literature, science, history, technology, and more. Whether you are conducting research, preparing for exams, or expanding your knowledge, RPITST E-Library is here to assist you every step of the way.

                Join RPITST E-Library today and embark on a journey of knowledge and discovery!
            </p>
            <br /><br />
            ...
            <p className='text-[19px] text-center'>
                ...
                ដោយមានការប្រមូលផ្ដុំសៀវភៅ បទពិសោធន៍ស្រាវជ្រាវ អត្ថបទ និងឯកសារប្រឡងច្រើនប្រភេទ បណ្ណាល័យអេឡិចត្រូនិករបស់វិទ្យាស្ថានបណ្ដុះបណ្ដាលពហុបច្ចេកទេសភូមិភាគតេជោសែនតាកែវក្លាយជាធនធានដ៏មានតម្លៃសម្រាប់និស្សិតដែលចង់បង្កើនចំណេះដឹង និងប្រសើរឡើងក្នុងការសិក្សា។ យើងខិតខំអភិវឌ្ឍមុខងារស្វែងរកដ៏មានឥទ្ធិពល និងផ្តល់នូវបទពិសោធន៍ប្រើប្រាស់ងាយស្រួលសម្រាប់អ្នករៀន។

                វេទិការបស់យើងគាំទ្រសៀវភៅជាច្រើនប្រភេទ រួមមានអក្សរសាស្រ្ត វិទ្យាសាស្រ្ត ប្រវត្តិសាស្រ្ត បច្ចេកវិទ្យា និងផ្សេងៗទៀត។ មិនថាអ្នកកំពុងស្រាវជ្រាវ រៀបចំសម្រាប់ការប្រឡង ឬបង្កើនចំណេះដឹងរបស់អ្នក ក៏បណ្ណាល័យអេឡិចត្រូនិករបស់វិទ្យាស្ថានបណ្ដុះបណ្ដាលពហុបច្ចេកទេសភូមិភាគតេជោសែនតាកែវនៅទីនេះដើម្បីជួយអ្នកគ្រប់ជំហាន។
